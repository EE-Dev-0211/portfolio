  ...
  return (
    <div className="grid gap-8 items-start justify-center my-8">
      <div className="relative group">
        ...
        ></div>
        {/*heading box*/}
        <div className="relative px-7 py-4 bg-white dark:bg-black rounded-lg leading-none flex items-center">
          <span className="flex items-center space-x-5  divide-x divide-black dark:divide-white">
            <span className="flex items-center pr-6 text-black dark:text-gray-100 font-extrabold">
              {icon} {title}
            </span>
            <span
              className="pl-6 text-indigo-600 group-hover:text-black
